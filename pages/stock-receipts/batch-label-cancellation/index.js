  ...
  return (
    <>
      <Breadcrumbs aria-label="breadcrumb">
        ...
        <Typography color="textPrimary">Batch Label Cancellation</Typography>
      </Breadcrumbs>
      <div>
        <Toolbar>
          <Link
            href="/stock-receipts/batch-label-cancellation/[id]"
            as="/stock-receipts/batch-label-cancellation/add"
          >
            <Controls.Button
              text="Add New"
              startIcon={<AddIcon />}
            ...
            {recordsAfterPagingAndSorting().map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell>
                  <Link
                    href={
                      "/stock-receipts/batch-label-cancellation/" + item.uuid
                    }
                    key={item.id}
                  >
