  ...
  return (
    <>
      <Breadcrumbs aria-label="breadcrumb">
        ...
        <Typography color="textPrimary">Batch Labeling</Typography>
      </Breadcrumbs>
      <div>
        <Toolbar>
          <Link
            href="/stock-receipts/batch-labeling/[id]"
            as="/stock-receipts/batch-labeling/add"
          >
            <Controls.Button
              text="Add New"
              startIcon={<AddIcon />}
          ...
          <TableBody>
            {recordsAfterPagingAndSorting().map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell>
                  <Link
                    href={"/stock-receipts/batch-labeling/" + item.uuid}
                    key={item.id}
                  >
